            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        default=datetime.datetime.today, verbose_name="Дата изменения"
                    ),
                ),
                (
                    "count",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(
                        default=datetime.datetime.today, verbose_name="Дата"
                    ),
                ),
                (
                    "action",
                    models.CharField(
                        choices=[("ADD", "Добавлено"), ("USED", "Использовано")],
                        default="USED",
                        max_length=15,
